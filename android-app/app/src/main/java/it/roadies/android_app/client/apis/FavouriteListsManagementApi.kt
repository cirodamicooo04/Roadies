...
import it.roadies.android_app.client.models.FavouriteListCreateRequest
import it.roadies.android_app.client.models.FavouriteListResponse
...
interface FavouriteListsManagementApi {
     ...
     */
    @POST("api/v1/favourite-lists/{listId}/activities/{activityId}")
    suspend fun addActivityToList(@Path("listId") listId: java.util.UUID, @Path("activityId") activityId: java.util.UUID): Response<Unit>
     ...
     */
    @POST("api/v1/favourite-lists/{listId}/friends/{friendId}")
    suspend fun addFriendToList(@Path("listId") listId: java.util.UUID, @Path("friendId") friendId: kotlin.String): Response<Unit>
     ...
     */
    @POST("api/v1/favourite-lists/{listId}/travels/{travelId}")
    suspend fun addTravelToList(@Path("listId") listId: java.util.UUID, @Path("travelId") travelId: java.util.UUID): Response<Unit>
     ...
     */
    @DELETE("api/v1/favourite-lists/{id}")
    suspend fun deleteList(@Path("id") id: java.util.UUID): Response<Unit>
     ...
     */
    @GET("api/v1/favourite-lists/{id}")
    suspend fun getList(@Path("id") id: java.util.UUID): Response<FavouriteListResponse>
     ...
     */
    @GET("api/v1/favourite-lists/my-lists")
    suspend fun getMyLists(): Response<kotlin.collections.List<FavouriteListResponse>>
     ...
     */
    @DELETE("api/v1/favourite-lists/{listId}/activities/{activityId}")
    suspend fun removeActivityFromList(@Path("listId") listId: java.util.UUID, @Path("activityId") activityId: java.util.UUID): Response<Unit>
     ...
     */
    @DELETE("api/v1/favourite-lists/{listId}/friends/{friendId}")
    suspend fun removeFriendFromList(@Path("listId") listId: java.util.UUID, @Path("friendId") friendId: kotlin.String): Response<Unit>
     ...
     */
    @DELETE("api/v1/favourite-lists/{listId}/travels/{travelId}")
    suspend fun removeTravelFromList(@Path("listId") listId: java.util.UUID, @Path("travelId") travelId: java.util.UUID): Response<Unit>
