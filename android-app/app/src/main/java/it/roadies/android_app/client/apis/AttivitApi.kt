...
import it.roadies.android_app.client.models.ActivityDepartureUpdateRequest
...
interface AttivitApi {
     ...
     */
    @POST("api/v1/activities/{activityId}/departures")
    suspend fun addDeparture1(@Path("activityId") activityId: java.util.UUID, @Body activityDepartureCreateRequest: ActivityDepartureCreateRequest): Response<ActivityDepartureResponse>
     ...
     */
    @PATCH("api/v1/activities/{activityId}/departures/{departureId}/confirm")
    suspend fun confirmDeparture1(@Path("activityId") activityId: java.util.UUID, @Path("departureId") departureId: java.util.UUID): Response<ActivityDepartureResponse>
     ...
     */
    @DELETE("api/v1/activities/{id}")
    suspend fun deleteActivity1(@Path("id") id: java.util.UUID): Response<kotlin.Any>
     ...
     */
    @DELETE("api/v1/activities/{activityId}/departures/{departureId}")
    suspend fun deleteDeparture1(@Path("activityId") activityId: java.util.UUID, @Path("departureId") departureId: java.util.UUID): Response<kotlin.Any>
     ...
     */
    @GET("api/v1/activities/public/{id}")
    suspend fun getActivity(@Path("id") id: java.util.UUID): Response<ActivityResponse>
     ...
     */
    @GET("api/v1/activities/{activityId}/price")
    suspend fun getActivityPrice(@Path("activityId") activityId: java.util.UUID): Response<java.math.BigDecimal>
     ...
     */
    @GET("api/v1/activities/public/{activityId}/departures")
    suspend fun getDepartures1(@Path("activityId") activityId: java.util.UUID): Response<kotlin.collections.List<ActivityDepartureResponse>>
     ...
     */
    @GET("api/v1/activities/{activityId}")
    suspend fun isValidActivity(@Path("activityId") activityId: java.util.UUID): Response<Unit>
     ...
     */
    @GET("api/v1/activities/review/{activityId}/")
    suspend fun isValidActivityAndIsNotIntoATravel(@Path("activityId") activityId: java.util.UUID): Response<Unit>
     ...
     */
    @PUT("api/v1/activities/{id}")
    suspend fun updateActivity1(@Path("id") id: java.util.UUID, @Body activityUpdateRequest: ActivityUpdateRequest): Response<ActivityResponse>
     ...
     */
    @PUT("api/v1/activities/{activityId}/departures/{departureId}")
    suspend fun updateDeparture1(@Path("activityId") activityId: java.util.UUID, @Path("departureId") departureId: java.util.UUID, @Body activityDepartureUpdateRequest: ActivityDepartureUpdateRequest): Response<ActivityDepartureResponse>
